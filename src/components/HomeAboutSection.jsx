		...
		<div className="container py-5 py-md-6">
			...
			<div className="row mt-5">
				<div className="col-12 col-md-6 col-xl-3 mb-4">
					<div className="lc-block shadow-sm border border-primary p-3 rounded text-center " data-aos="fade-right" data-aos-delay="2	00">
						...
						<div className="lc-block">
							<div editable="rich">
								...
								<p className="text-muted">Tailored assessments, plans, and one-on-one support to align your career with your unique goals.</p>
							</div>
						</div>
					</div>
				</div>
				<div className="col-12 col-md-6 col-xl-3 mb-4">
					<div className="lc-block shadow-sm border border-primary p-3 rounded text-center " data-aos="fade-up" data-aos-delay="2	00">
						<div className="h1 text-primary lc-block rounded-circle d-flex justify-content-center align-items-center mx-auto mb-2" >
						...
						<div className="lc-block">
							<div editable="rich">
								...
								<p className="text-muted">Access proven strategies, tools, and tips to enhance your CV, LinkedIn profile, and interview skills.</p>
							</div>
						</div>
					</div>
				</div>
					...
					<div className="lc-block shadow-sm border border-primary p-3 rounded text-center " data-aos="fade-up" data-aos-delay="2	00">
						...
						<div className="lc-block">
							<div editable="rich">
								...
								<p className="text-muted">From career discovery to securing your dream job, we guide you every step of the way.</p>
							</div>
						</div>
					</div>
				</div>
				<div className="col-12 col-md-6 col-xl-3 mb-4">
					<div className="lc-block shadow-sm border border-primary p-3 rounded text-center " data-aos="fade-left" data-aos-delay="2	00">
						<div className="h1 text-primary lc-block rounded-circle d-flex justify-content-center align-items-center mx-auto mb-2" >
							{/* <svg xmlns="http://www.w3.org/2000/svg" width="2em" height="2em" fill="currentColor" className="text-info" viewBox="0 0 16 16" style="" lc-helper="svg-icon">
						...
						<div className="lc-block">
							<div editable="rich">
								...
								<p className="text-muted">Trusted by countless graduates to elevate their profiles and achieve career success.</p>
							</div>
						</div>
					</div>
				</div>
